...
class GithubClient:
    def __init__(self):
        ...
        self.headers = {
            ...
            "Authorization": f"token {settings.GITHUB_ACCESS_TOKEN}" if settings.GITHUB_ACCESS_TOKEN else ""
        }
    ...
    async def fetch_contributors(self, owner: str, repo: str, per_page: int = 10):
    ...
    # Level 4
    async def fetch_repo_tree(self, owner: str, repo: str, branch: str = "main"):
    ...
    # Level 9
    async def fetch_releases(self, owner: str, repo: str, per_page: int = 5):
